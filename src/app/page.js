...
export default function Home() {
  return (
    <main>
      <section  className="mt-14 lg:mt-0 lg:flex items-center justify-between banner-home-desktop max-w-[1300px] mx-auto fadeInUp" style={{animationDelay: "0.3s"}} id="home">
        <div
          className="px-5 lg:max-w-[470px] xl:max-w-[500px]"
        >
            <h1 className="fadeInUp text-white text-[28px] lg:text-[50px] font-bold leading-[34px] lg:leading-[56px]" style={{animationDelay: "0.3s"}}>
              Hi, I am <br /> Iván Palacios
            </h1>
          <h2
            className="fadeInUp mt-6 text-[#828282] font-[600] text-[18px] lg:text-[26px]" style={{animationDelay: "0.6s"}}
          >
            Frontend Engineer
          </h2>

          <p className="fadeInUp mt-2 text-white font-[200] text-[18px] lg:text-[20px]" style={{animationDelay: "0.6s"}}>
            Building pixel-perfect, engaging and accessible frontend products with best user experiences.
          </p>

          <div className="fadeInUp mt-6 flex items-center gap-6" style={{animationDelay: "0.6s"}}>
            <button
        ...
        >
          <Image
            ...
            alt="foto-personal"
            className="w-[75%] md:max-w-[400px] h-auto object-cover lg:hidden fadeInUp"
            width={300}
            height={600}
            priority
        ...
        <div className="fadeInUp px-5" style={{animationDelay: "1.2s"}}>
      ...
      <section className="px-5 mt-20 lg:mt-28 max-w-[1300px] mx-auto" id="about-me">
        <ScrollAnimation animateIn="fadeInUp" animateOnce duration={0.7} className="lg:hidden">
        ...
        <div className="fadeInUp hidden lg:block" style={{animationDelay: "0.6s"}}>
          <h1 className="text-white text-[36px] lg:text-[50px] font-bold leading-[42px] text-center">
            <span className="text-primary">/</span>About me
          </h1>
        ...
        <div className="mt-14 lg:mt-20">
          <ScrollAnimation animateIn="fadeInUp" animateOnce duration={0.7}>
      ...
      {/* Sección Experience */}
      <section className="px-5 mt-20 lg:mt-28 max-w-[1300px] mx-auto" id="experience">
